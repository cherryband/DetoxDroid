...
%cd%\platform-tools\adb.exe shell pm grant space.cherryband.digitaldetox android.permission.WRITE_SECURE_SETTINGS
%cd%\platform-tools\adb.exe shell dpm set-device-owner space.cherryband.digitaldetox/.DetoxDroidDeviceAdminReceiver

echo Starting App
%cd%\platform-tools\adb.exe shell monkey -p space.cherryband.digitaldetox 1
